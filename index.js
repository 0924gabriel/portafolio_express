...
app.get('/', (req, res) => {
 ...
 app.get('/descripcion', (req, res) => {
    // res.send('hello')
    res.render('descripcion',{titulo:"descripcion"})
  })

app.get('/estudios', (req, res) => {
  res.render('estudios',)
})
app.get('/refereciasfami', (req, res) => {
  res.render('referecias_fami',)
})
app.get('/referenciasperso', (req, res) => {
  res.render('referencia_perso',{titulo:"refencias personales"})
})
